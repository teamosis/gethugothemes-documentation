...
In this theme there are two type of homepage. One is grid type and another is list type of homepage. Content folder contains the folder homepage file as `grid.md` and `list.md`. Open this page in any text editor, and you will be able to edit it. Some of the sections can hide. You can change its `enable` value to `false`.
