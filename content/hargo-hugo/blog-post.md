---
title: 'Blog Post'
date: '2019-11-10T08:50:35-03:00'
weight: 5
draft: false
---
...
You can configure your blog post from the front-matter. Front-matter starts with `---` and end with also `---` . In this front matter you can give `description = meta description`, `image = images/blog/post-thumb.jpg. `\*\*One thing is remember that you must need to declare the `type = post`. \*\*
