...
You can configure your blog post from the front-matter. Front-matter starts with `---` and end with also `---` . In this front matter you can give `title`, `date`, `bg_image = images/backgrounds/blog-page.jpg`,  `author = author name`, `description = meta description`, `image = images/blog/blog-post-1.jpg`, `type` and `tags`.
