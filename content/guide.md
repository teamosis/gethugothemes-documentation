...
This instruction with learning resources is created for users who do not have any Hugo development experience. However, these instructional resources aided developers of all skill levels.
...
First of all, you need to [install hugo-extended](https://gohugo.io/getting-started/installing/) version in your machine. Extended version is mandatory if you want to compile `SASS` or `SCSS`.

**For homebrew users, you can install Hugo with the following command.**
...
Download and Install the [Go language](https://go.dev/doc/install) from the official website of Go. You will get the installation instructions according to your operating system on the site.

**For homebrew users, you can install Go with the following command.**
...
Now, go to the official website of [nodejs](https://nodejs.org/en/) and install it in your system. We recommend you install the LTS version.
