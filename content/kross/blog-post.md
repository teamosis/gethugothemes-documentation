...
You can configure your blog post from the front-matter. Front-matter starts and ends with `---`. In this front matter you can add an `author = "Author Name"`, `description = meta description`, and `image = images/blog/post-thumb.jpg`. The date will be automatically filled. 
